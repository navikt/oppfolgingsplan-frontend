...
export const TiltakFormHeading = (): ReactElement => {
    ...
    const title = isAudienceSykmeldt ? arbeidstakerTexts.title : arbeidsgiverTexts.title
    const body = isAudienceSykmeldt ? arbeidstakerTexts.body : arbeidsgiverTexts.body
    return (
        <>
