...
export const VelgArbeidsgiverUndertekst = ({oppfolgingsplaner, arbeidsgiver}: ArbeidsgiverUndertekstProps) => {
    if (erAktivOppfolgingsdialogOpprettetMedArbeidsgiver(oppfolgingsplaner, arbeidsgiver.virksomhetsnummer)) {
...
export const ArbeidsgiverSkjema = ({arbeidsgivere, oppfolgingsplaner, handleSubmit}: ArbeidsgiverSkjemaProps) => {
    return (
            ...
            <div>
                <div>
                    <Button variant={"primary"}
                            disabled={!erOppfolgingsdialogOpprettbarMedMinstEnArbeidsgiver(oppfolgingsplaner, arbeidsgivere)}
                    >
