...
export const TilretteleggingsBeskrivelse = ({
                                                gjennomfoering
                                            }: Props) => {
    return (
        <>
            ...
            <ul>
                {gjennomfoering.paaAnnetSted && <li>{texts.arbeidsoppgaveList.labels.sted}</li>}
                {gjennomfoering.medMerTid && <li>{texts.arbeidsoppgaveList.labels.tid}</li>}
                {gjennomfoering.medHjelp && <li>{texts.arbeidsoppgaveList.labels.hjelp}</li>}
            </ul>
