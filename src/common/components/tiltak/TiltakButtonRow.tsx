...
export const TiltakButtonRow = ({oppfolgingsplanId, tiltakId, aktoerHarOpprettetElement}: Props) => {
    return (
        <ButtonRow>
            {aktoerHarOpprettetElement && <Button variant={"tertiary"} icon={<Edit/>}>Endre</Button>}
            {aktoerHarOpprettetElement && <SlettTiltakButton oppfolgingsplanId={oppfolgingsplanId} tiltakId={tiltakId}/>}
