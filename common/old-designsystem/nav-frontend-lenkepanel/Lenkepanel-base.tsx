...
const cls = (className: any, border: any) =>
...
(LenkepanelBase as unknown as React.ComponentClass).propTypes = {
    /**
     * Klassenavn
     */
    className: PT.string,
...
(LenkepanelBase as unknown as React.ComponentClass).defaultProps = {
    className: undefined,
